      ...
      <form class="validate" id="generatecode" name="generatecode" method="post" action="">
        ...
        <div id="tab-7" class="tabs" style="display:none;">
          ...
          <table class="form-table">
            <tbody>
            <tr class="form-field">
                <th><label>Media ID<span class="description">(required)</span></label></th>
                <td>
                    <input type="text" name="media[media_id]" style="width: 20%;" id="media_id" value="<?php echo strtoupper("media_".substr(md5(rand()), 0, 7));?>" readonly="readonly" class="validate[required]">
               </td>
              </tr>
             <tr class="form-field">
              ...
              <tr class="form-field">
                ...
                <td>
                    <select name="admin_order[orderby]" id="admin_order_orderby" style="width: 20%;">
                        ...
                        <option value="comment_count">No Of Comment</option>
                        <option value="meta_value">Meta Value</option>
                        <option value="meta_value_num">Meta Value(Numeric)</option>
                    </select>
                </td>
              </tr>
              <tr class="form-field">
